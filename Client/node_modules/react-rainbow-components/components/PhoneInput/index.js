...
var PhoneInput = _react["default"].forwardRef(function (props, ref) {
  ...
  var inputId = (0, _hooks.useUniqueIdentifier)('phone-input');
  var errorMessageId = (0, _hooks.useErrorMessageId)(error);
  var labelId = (0, _hooks.useLabelId)(label);
  var phone = value && value.phone || '';
  var countries = (0, _hooks2.useCountries)(countriesProps);
  var country = (0, _hooks2.useCountry)(value, countries);
  var countryCode = country.countryCode,
      isoCode = country.isoCode,
      flagIcon = country.flagIcon;

  var _useFocusIndex = (0, _hooks2.useFocusIndex)(containerRef, triggerRef, searchRef, inputRef),
      _useFocusIndex2 = (0, _slicedToArray2["default"])(_useFocusIndex, 2),
      focusIndex = _useFocusIndex2[0],
      setFocusIndex = _useFocusIndex2[1];

  var handleFocus = (0, _hooks2.useHandleFocus)(focusIndex, onFocus, setFocusIndex);
  var handleBlur = (0, _hooks2.useHandleBlur)(focusIndex, onBlur);
  var isOpen = focusIndex === 1;
  var handleCountryChange = (0, _hooks2.useHandleCountryChange)(phone, onChange, setFocusIndex, isOpen);

  function handlePhoneChange(event) {
    var newPhone = event.target.value;
  ...
  return _react["default"].createElement(_container["default"], {
    ...
    error: error,
    disabled: disabled
  })))), _react["default"].createElement(_styled.StyledCountryCode, null, formattedCountryCode), _react["default"].createElement(_styled.StyledInput, {
    id: inputId,
    ref: inputRef,
    name: name,
    value: phone,
